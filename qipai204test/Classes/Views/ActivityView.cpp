/********************************************************************************
	File: ActivityView.cpp
	
	Written by: 杨杰
	Copyright:  www.zyios.com 2013-05-25
	
	ActivityView 类是一个活动信息列表界面类，用来显示活动信息内容
	ActivityView 实现
...
bool ActivityView::init() {
	...
	// 开始更新时间,1秒更新一次
	// this->schedule(schedule_selector(ActivityView::updateTimeLabel), 1.0f) ;
 ...
 * 处理返回键事件
 */
 void ActivityView::keyBackClicked() {
...
void ActivityView::CCListView_numberOfCells(CCListView *listView, CCListViewProtrolData *data) 
{
...
void ActivityView::CCListView_didClickCellAtRow(CCListView *listView, CCListViewProtrolData *data) 
{
	CCLog("Click row index is : %d", data->nRow) ;
}
 
void ActivityView::CCListView_didScrollToRow(CCListView *listView, CCListViewProtrolData *data) 
{
	CCLog("ListView Scrolling!") ;
}


void ActivityView::visit()
{
    CCLayer::visit();
    if (fresh) {
        this->contentListView->reload();
        fresh = false;
    }
}
/**
 * 存值菜单点击事件处理函数
 */
void ActivityView::menuStoreClickCallback(CCObject* pSender) {}

/**
 * 礼包菜单点击事件处理函数
 */
void ActivityView::menuGiftsClickCallback(CCObject* pSender) 
{}

/**
 * 返回菜单点击事件处理函数
 */
void ActivityView::menuBackClickCallback(CCObject* pSender) 
{
	// CCScene* scene = CCTransitionFlipX::create(0.8f, GameMenuView::CreateScene(), kOrientationRightOver) ;
...
//  * 帮助菜单点击事件处理函数
//  */
// void ActivityView::menuHelpClickCallback(CCObject* pSender) 
// {
	
// #if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)	// 条件编译语句，如果是Android平台
// 	JniMethodInfo t;
 
// 	if (JniHelper::getStaticMethodInfo(t, "com/zyios/goldenfraud/activity/HelpActivity", "startHelpActivity", "(Ljava/lang/String;Ljava/lang/String;)V"))
// 	{
 ...
 * 设置菜单点击事件处理函数
 */
void ActivityView::menuSettingClickCallback(CCObject* pSender) {}

/**
 *	底部信息菜单
 */
void ActivityView::menuInfoClickCallback(CCObject* pSender) 
{
 ...
 * 底部任务菜单
 */
void ActivityView::menuTaskClickCallback(CCObject* pSender) 
{
 ...
 * 底部商城菜单
 */
void ActivityView::menuShopClickCallback(CCObject* pSender) 
{
...
* 底部活动菜单项
*/
void ActivityView::menuActivityClickCallback(CCObject* pSender) {}


/**
* 底部活动菜单项
*/
void ActivityView::menuMoreClickCallback(CCObject* pSender) 
{
	// 设置更多菜单显示标志
...
* 更多 排行榜菜单项
*/
void ActivityView::menuRankingClickCallback(CCObject* pSender) 
{}

/**
 * 好友菜单点击事件处理函数
 */
void ActivityView::menuFriendClickCallback(CCObject* pSender) 
{}

/**
 * 客服菜单点击事件处理函数
 */
void ActivityView::menuCustomServiceClickCallback(CCObject* pSender) 
{}
...
// 初始化中间部分bar
void ActivityView::initCenterBar(CCSize winSize) 
{
