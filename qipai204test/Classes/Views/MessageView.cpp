...
bool MessageView::init() {
	...
	// 开始更新时间,1秒更新一次
	// this->schedule(schedule_selector(MessageView::updateTimeLabel), 1.0f) ;
 ...
 * 处理返回键事件
 */
 void MessageView::keyBackClicked() {
...
void MessageView::CCListView_numberOfCells(CCListView *listView, CCListViewProtrolData *data) 
{
...
void MessageView::CCListView_didClickCellAtRow(CCListView *listView, CCListViewProtrolData *data) 
{
	CCLog("Click row index is : %d", data->nRow) ;
}
 
void MessageView::CCListView_didScrollToRow(CCListView *listView, CCListViewProtrolData *data) 
{
 ...
 * 存值菜单点击事件处理函数
 */
void MessageView::menuStoreClickCallback(CCObject* pSender) {}

/**
 * 礼包菜单点击事件处理函数
 */
void MessageView::menuGiftsClickCallback(CCObject* pSender) 
{}

/**
 * 返回菜单点击事件处理函数
 */
void MessageView::menuBackClickCallback(CCObject* pSender) 
{
	// CCScene* scene = CCTransitionFlipX::create(0.8f, GameMenuView::CreateScene(), kOrientationRightOver) ;
	// CCDirector::sharedDirector()->replaceScene(scene) ;
	CCDirector::sharedDirector()->replaceScene(GameMenuView::CreateScene()) ;
 ...
 * 设置菜单点击事件处理函数
 */
void MessageView::menuSettingClickCallback(CCObject* pSender) {}

/**
 *	底部信息菜单
 */
void MessageView::menuInfoClickCallback(CCObject* pSender) {}


/*
 * 底部任务菜单
 */
void MessageView::menuTaskClickCallback(CCObject* pSender) 
{
 ...
 * 底部商城菜单
 */
void MessageView::menuShopClickCallback(CCObject* pSender) 
{
...
* 底部活动菜单项
*/
void MessageView::menuActivityClickCallback(CCObject* pSender) 
{
...
* 底部活动菜单项
*/
void MessageView::menuMoreClickCallback(CCObject* pSender) 
{
	// 设置更多菜单显示标志
...
* 更多 排行榜菜单项
*/
void MessageView::menuRankingClickCallback(CCObject* pSender) 
{}

/**
 * 好友菜单点击事件处理函数
 */
void MessageView::menuFriendClickCallback(CCObject* pSender) 
{}

/**
 * 客服菜单点击事件处理函数
 */
void MessageView::menuCustomServiceClickCallback(CCObject* pSender) 
{}
...
// 初始化中间部分bar
void MessageView::initCenterBar(CCSize winSize) 
{
...
// 初始化底部Bar
void MessageView::initBottomBar(CCSize winSize) 
{
	/////////////////////////////////////////// 底部条 ////////////////////////////////////////
	...
	CCMenuItemImage* activityMenuItem = CCMenuItemImage::create("menu_activity_n.png", "menu_activity_s.png", 
																this, menu_selector(MessageView::menuActivityClickCallback)) ;
	...
	CCMenuItemImage* infoMenuItem = CCMenuItemImage::create("menu_message_n.png", "menu_message_s.png", 
															this, menu_selector(MessageView::menuInfoClickCallback)) ;
	...
	CCMenuItemImage* shopMenuItem = CCMenuItemImage::create("menu_shop_n.png", "menu_shop_s.png", 
															this, menu_selector(MessageView::menuShopClickCallback)) ;
	...
	CCMenuItemImage* moreMenuItem = CCMenuItemImage::create("menu_more_n.png", "menu_more_s.png" , 
															this, menu_selector(MessageView::menuMoreClickCallback)) ;
